  ...
  useEffect(() => {
      ...
      .then( (querySnapshot) => {
        ...
        querySnapshot.forEach((documentSnapshot) => {
          collectionsList.push({ data : documentSnapshot.data(), id: documentSnapshot.id})
  ...
  if (loading) {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#fff', padding: 16 }}>
        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 16, textAlign: 'center' }}>My Collections</Text>
        ...
        <View style={{ position: 'absolute', bottom: 32, left: '43%', transform: [{ translateX: -50 }], backgroundColor: '#FF9F00', borderRadius: 20, paddingHorizontal: 14 }}>
          <Link href="/add-collection" collections={collections} setCollections={setCollections} asChild>
            <Button title="Add Collection +" color="white" style={styles.addButton}/>
          </Link>
        </View>
      </View>
    );
